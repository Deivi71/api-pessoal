...
func CriarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorys.NewRepositoryPublicacoes(db)
...
// BuscarTodasPublicacoes - busca todas as publicações (feed público)
func BuscarTodasPublicacoes(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorys.NewRepositoryPublicacoes(db)
	publicacoes, erro := repositorio.BuscarTodasPublicas()
	if erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
...
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorys.NewRepositoryPublicacoes(db)
	publicacaoSalvaoBanco, erro := repositorio.BuscarPorID(publicacaoID)
	if erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}

	if publicacaoSalvaoBanco.AutorID != usuarioID {
...
// CurtirPublicacao - curtir uma publicação
...
// DescurtirPublicacao - descurtir uma publicação
func DescurtirPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorys.NewRepositoryPublicacoes(db)
	if erro = repositorio.Descurtir(publicacaoID, usuarioID); erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
